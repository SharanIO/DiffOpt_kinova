...
from cbfqp_solver import CBFQPSolver
from exp_utils import get_Q_mat
...
class ThreeBlocksController(BaseController):
    def __init__(self, crude_type="ellipsoid"):
        ...
        # define solver
        self.solver = CBFQPSolver(13, 0, 21)
    ...
    def controller(self, t, q, dq):
        ...
        params = {
            ...
            "nullspace_proj": np.eye(13) - pinv_jac @ jacobian,
            "lb": lb,
            "C": C,
        }
