...
function create_arm()
    ...
    =#
    P2 = sa.@SMatrix [1/(0.165*0.165) 0.0 0.0
        0.0 1/(0.09*0.09) 0.0
        0.0 0.0 1/(0.09*0.09)]

    P3 = sa.@SMatrix [1/(0.15*0.15) 0.0 0.0
        0.0 1/(0.09*0.09) 0.0
        0.0 0.0 1/(0.09*0.09)]

    P4 = sa.@SMatrix [1/(0.14*0.14) 0.0 0.0
        0.0 1/(0.09*0.09) 0.0
        0.0 0.0 1/(0.09*0.09)]

    P5 = sa.@SMatrix [1/(0.125*0.125) 0.0 0.0
    ...
    global link2 = dc.Ellipsoid(P2)
    global link3 = dc.Ellipsoid(P3)
    global link4 = dc.Ellipsoid(P4)
    global link5 = dc.Ellipsoid(P5)
